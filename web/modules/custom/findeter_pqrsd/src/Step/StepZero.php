...
class StepZero extends BaseStep {
  ...
  public function buildStepFormElements($steps,$form,$form_state) {
    ...
    $formStep['title']['#markup'] = '
      ...
      Lo invitamos a que consulte nuestras políticas y condiciones del servicio de atención. También puede contactar directamente a la entidad a través de nuestra línea telefónica gratuita de atención al cliente, Peticiones, Quejas, Reclamos y Denuncias 01-8000-116622.<br><br>
      Si usted considera que su identidad debe mantenerse reservada al encontrarse en alguna de las circunstancias establecidas en el parágrafo del articulo 4  de la ley 1712/2014,deberá radicar  petición en este <a href="https://www.procuraduria.gov.co/portal/solicitud_informacion_identificacion_reservada.page">cuestionario</a>; de lo contrario lo invitamos a seleccionar el tipo de solicitud que desea presentar.<br><br>
