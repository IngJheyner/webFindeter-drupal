...
use Drupal\findeter_user_form_request\Button\StepZeroNextButton;
...
class StepZero extends BaseStep {
  ...
  public function buildStepFormElements($steps,$form,$form_state) {
    ...
    $formStep['title']['#markup'] = '
      ...
      <p>Por favor tenga en cuenta las siguientes definiciones para establecer el tipo de solicitud a presentar y los <a href="#">términos de respuesta</a> a tener en cuenta:</p>
    ';
